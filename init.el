...
(use-package auto-package-update
  ...
  :hook (auto-package-update-before-hook . (lambda () (message "Update all the things!!!1"))))
...
(use-package cider
  ...
  (setq
    ...
    cider-repl-use-pretty-printing t)                          ;; not necessary, but useful for trouble-shooting
...
(use-package highlight-defined
  ...
  :hook ((emacs-lisp-mode . highlight-defined-mode)
         (clojure-mode . highlight-defined-mode)))
...
(use-package dired-sidebar
  ...
  ;;(setq dired-sidebar-subtree-line-prefix "＿")
